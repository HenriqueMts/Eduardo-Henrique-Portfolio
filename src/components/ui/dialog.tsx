  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-white data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-[95vw] max-h-[90vh] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border border-neutral-200 p-4 shadow-lg duration-200 overflow-y-auto sm:w-full sm:max-w-lg sm:p-6 dark:bg-neutral-950 dark:border-neutral-800",
          className,
        )}
        {...props}
      >
